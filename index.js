...
const productosDisponibles = JSON.parse(localStorage.getItem('heladosObjetoElegidos10')) || [];
...
<div class="item-producto">
    ...
    <button class="btn-agregar-carrito" id="btn-agregar-${producto.nombre}">Agregar al Carrito</button>
</div>
`;
});
...
const boton = document.getElementById(`btn-agregar-${producto.nombre}`)
...
const indiceProductoExistente = carrito.findIndex(item => item.nombre === productoAAgregar.nombre);
