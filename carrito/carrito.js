            ...
            return `
                        <div class="item-carrito">
                            ...
                            <div>
                                ...
                                <button class="btn-eliminar-item" id="btn-eliminar-${item.nombre}">Eliminar</button>
                            </div>
                        </div>
                    `;
        });
